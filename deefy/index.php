  ...
  <header class="topbar">
    ...
    <div class="user-menu">
      ...
      <div class="dropdown-menu" id="dropdownMenu">
        ...
        <a href="classes/profile.php">Mon profil</a>
        <hr>
        <a href="classes/Log_Sig.php?action=logout" class="logout">Se déconnecter</a>
      </div>
    </div>
    <?php else: ?>
      <a href="classes/Log_Sig.php" class="login">Se connecter / S'inscrire</a>
    <?php endif; ?>
  </header>
